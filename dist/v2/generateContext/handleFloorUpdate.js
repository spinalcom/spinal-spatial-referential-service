...
const serverIdArrToNodeIdArr_1 = require("../utils/serverIdArrToNodeIdArr");
const spinal_env_viewer_context_geographic_service_1 = require("spinal-env-viewer-context-geographic-service");
function handleFloorUpdate(floorData, buildingNode, dataToDo, skipList, bimFileId) {
    return __awaiter(this, void 0, void 0, function* () {
        const floorNode = (spinal_core_connectorjs_type_1.FileSystem._objects[floorData.floorArchi.properties.spinalnodeServerId]);
        ...
        console.log('new rooms', floorData.diff.diffRoom.newRooms);
...
function getRoomCmdUp(floorData, floorNode, roomCmds, bimFileId, roomRefCmds, skipList) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const { diff, roomArchi } of floorData.diff.diffRoom.updateRooms) {
            ...
            const roomNode = (spinal_core_connectorjs_type_1.FileSystem._objects[roomArchi.properties.spinalnodeServerId]);
            const roomCmd = {
                pNId: floorNode.info.id.get(),
