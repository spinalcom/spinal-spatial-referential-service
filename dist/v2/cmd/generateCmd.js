...
const getModType_1 = require("../utils/getModType");
const isInSkipList_1 = require("../utils/isInSkipList");
const handleFloorCmdNew_1 = require("./handleCmd/handleFloorCmdNew");
const handleFloorUpdate_1 = require("./handleCmd/handleFloorUpdate");
function generateCmd(data, skipList, buildingServerId, bimFileId) {
    return __awaiter(this, void 0, void 0, function* () {
        const dataToDo = [];
        const buildingNode = spinal_core_connectorjs_type_1.FileSystem._objects[buildingServerId];
